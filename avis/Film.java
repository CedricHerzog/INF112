...
public class Film extends Item {
	...
	/**
	 */
	public void checkIfItemAlreadyExists(SocialNetwork sn) throws ItemFilmAlreadyExists {
		//On parcourt les films à la recherche d'une correspondance
		for (Film m : sn.getListFilms())
		{
			//Si il y a correspondance, on renvoi une exception ItemFilmAlreadyExists
			if (m.getTitre().trim().equalsIgnoreCase(this.titre.trim())){
